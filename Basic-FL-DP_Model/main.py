...
def create_directories():
    ...
    for dir_path in [
        ...
        "./visualizations/gradient_reconstruction"  # Add directory for gradient reconstruction visualizations
    ]:
...
def generate_privacy_visualizations(args):
    ...
    try:
        ...
        noise_values = [0.5, 0.8, 1.0, 1.5]  # MODIFIED: Include 0.8 which is our new default
...
def generate_comparison_experiment_data(args):
    ...
    try:
        ...
        noise_values = [0.5, 0.8, 1.0, 1.5, 2.0]  # MODIFIED: Include 0.8 in the comparison
...
def main(args):
    ...
    server_process = multiprocessing.Process(
        target=server_main,
        args=[args.num_rounds, args.num_clients, args.strategy, args.proximal_mu]  # Pass strategy and mu to server
    )
...
if __name__ == "__main__":
    ...
    # MODIFIED: Increased default rounds and epochs
    ...
    # MODIFIED: Reduced noise multiplier to allow better learning while still maintaining privacy
