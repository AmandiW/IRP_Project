...
class RetinopathyClient(fl.client.NumPyClient):
    ...
    def __init__(self, client_id, train_loader, test_loader, train_size, test_size,
        ...
        # Create privacy visualizations at initialization
    ...
    def _create_privacy_visualizations(self):
        ...
        self.logger.info(f"Client {self.client_id} - Created privacy visualizations")
...
def start_client(client_id, model_config=None, dp_params=None):
    ...
    if "noise_multiplier" in dp_params:
        # Vary noise multiplier between 0.75 and 0.85 depending on client_id
