...
# FedProx is mainly used as the aggregating technique for Non-IID Data Distributions.
class DPFedProx(fl.server.strategy.FedProx):
    ...
    def aggregate_fit(self, server_round, results, failures):
        ...
        # Create additional privacy-related visualizations if this is the final round
        if server_round == self.num_rounds:
            self.logger.info("Final round completed. Generating privacy analysis visualizations...")
            ...
            try:
                ...
                try:
                    ...
                    if sample_data and len(sample_data) > 0:
                        ...
                        if attack_accuracy < 0.6:  # Success would be > 0.7 as seen in literature
...
# Default parameters if user hasn't added inputs
