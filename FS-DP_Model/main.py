...
def generate_privacy_visualizations(args):
    ...
    try:
        ...
        # These visualizations are purely theoretical, therefore isn't used in Final Evaluation
...
if __name__ == "__main__":
    ...
    parser.add_argument('--noise_multiplier', type=float, default=1, help='Noise multiplier for DP')
