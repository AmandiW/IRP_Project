...
class RetinopathyClient(fl.client.NumPyClient):
    def __init__(self, client_id, train_loader, test_loader, train_size, test_size,
        ...
        self.model, self.optimizer, self.train_loader = self.privacy_engine.make_private_with_epsilon(
            ...
            epochs=2,
            target_epsilon=3.0,
            target_delta=1 / self.train_size,
        ...
        self.logger.info(f"Client {self.client_id} - Differential privacy enabled with epsilon target: 3.0")
    ...
    def fit(self, parameters, config):
        ...
        for epoch in range(2):
            ...
            # Get privacy spent
            epsilon = self.privacy_engine.get_epsilon(delta=1 / self.train_size)
            ...
            self.logger.info(f"Client {self.client_id} - Epoch {epoch} - Privacy budget spent (ε): {epsilon:.2f}")
